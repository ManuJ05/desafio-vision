# Desafío Técnico: Visión por Computadora e Inteligencia Artificial
...
Arquitectura: Implementa un cliente AWS S3 con Boto3 configurado para operar sobre una Nube Local (o bucket simulado), demostrando la capacidad de subir telemetría de forma asíncrona sin bloquear el procesamiento de video.
...
├── ejercicio1.py         # Script HAR + Cliente S3 (Boto3)
...
├── configuracion_vivo.json # Configuración de parámetros
